...
if __name__ == "__main__":
 ...
 > ${SAVE_DIR}logfile_${EXP_NUM}.out'''
    ...
    parser.add_argument('--warmup_model_exp_id', type=str, default='(02.08.2022_|_25.076)')
    parser.add_argument('--model_name', type=str, default='vit_dino', help='Format is {model_name}_{pretrain}')
    parser.add_argument('--search_mode', type=str, default='other', help='Mode for black box optimisation')
