...
def kmeans_semi_sup(merge_test_loader, args, K=None):
    ...
    all_feats = np.concatenate(all_feats)  # (5994, 768)

    l_feats = all_feats[mask_lab]       # Get labelled set           [1498,768]
...
if __name__ == "__main__":
 ...
 --use_best_model 'True' --max_kmeans_iter 200 --k_means_init 100 --warmup_model_exp_id '(25.08.2022_|_45.889)'\
 > ${SAVE_DIR}logfile_${EXP_NUM}.out'''
    ...
    parser.add_argument('--warmup_model_exp_id', type=str, default='(25.08.2022_|_45.889)')
    ...
    all_acc, old_acc, new_acc, kmeans = kmeans_semi_sup(train_loader, args, K=args.K)
