...
def get_cifar_50_datasets(train_transform, test_transform, train_classes=range(50),
                       prop_train_labels=0.5, split_train_val=False, seed=0):
...
def get_cifar_90_10_datasets(train_transform, test_transform, train_classes=range(90),
...
def get_cifar_80_20_datasets(train_transform, test_transform, train_classes=range(80),
                       prop_train_labels=0.8, split_train_val=False, seed=0):
    ...
    return all_datasets
def get_cifar_70_30_datasets(train_transform, test_transform, train_classes=range(70),
...
def get_cifar_60_40_datasets(train_transform, test_transform, train_classes=range(60),
...
def get_cifar_50_50_datasets(train_transform, test_transform, train_classes=range(50),
                       prop_train_labels=0.5, split_train_val=False, seed=0):
    ...
    return all_datasets
def get_cifar_40_60_datasets(train_transform, test_transform, train_classes=range(40),
...
def get_cifar_30_70_datasets(train_transform, test_transform, train_classes=range(30),
...
def get_cifar_20_80_datasets(train_transform, test_transform, train_classes=range(20),
...
def get_cifar_10_90_datasets(train_transform, test_transform, train_classes=range(10),
